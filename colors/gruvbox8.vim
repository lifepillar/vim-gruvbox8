...
" Last Updated: Fri Jun  2 13:10:48 2023
...
if &background == 'dark'
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi ErrorMsg ctermfg=235 ctermbg=203 cterm=NONE
    ...
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=235 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=235 cterm=italic
    elseif s:bold_italic == 2
...
if &background == 'light'
  ...
  hi Terminal guifg=#fbf1c7 guibg=#3c3836 guisp=NONE gui=NONE
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi Error ctermfg=124 ctermbg=230 cterm=reverse
      hi ErrorMsg ctermfg=230 ctermbg=124 cterm=NONE
    ...
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=230 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=230 cterm=italic
    elseif s:bold_italic == 2
