...
" Last Updated: Sat Jun  5 16:46:43 2021
...
if s:t_Co >= 256
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign ctermfg=124 ctermbg=187 cterm=reverse
    hi CocWarningSign ctermfg=124 ctermbg=187 cterm=reverse
    hi CocInfoSign ctermfg=172 ctermbg=187 cterm=reverse
    hi CocHintSign ctermfg=23 ctermbg=187 cterm=reverse
