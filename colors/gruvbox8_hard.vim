...
" Last Updated: Fri Jun  2 13:06:40 2023
...
if &background == 'dark'
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi Error ctermfg=203 ctermbg=234 cterm=reverse
      hi ErrorMsg ctermfg=234 ctermbg=203 cterm=NONE
    ...
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=234 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=234 cterm=italic
    elseif s:bold_italic == 2
...
if &background == 'light'
  ...
  hi Terminal guifg=#f9f5d7 guibg=#3c3836 guisp=NONE gui=NONE
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi Error ctermfg=124 ctermbg=229 cterm=reverse
      hi ErrorMsg ctermfg=229 ctermbg=124 cterm=NONE
      hi Function ctermfg=100 ctermbg=NONE cterm=NONE
      hi MatchParen ctermfg=NONE ctermbg=187 cterm=underline
      hi ModeMsg ctermfg=172 ctermbg=NONE cterm=NONE
      hi MoreMsg ctermfg=172 ctermbg=NONE cterm=NONE
      hi PmenuSel ctermfg=187 ctermbg=23 cterm=NONE
      ...
      hi WildMenu ctermfg=23 ctermbg=187 cterm=NONE
    endif
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=229 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=229 cterm=italic
    elseif s:bold_italic == 2
      hi Todo ctermfg=fg ctermbg=229 cterm=bold
    endif
    if s:ft == 1
