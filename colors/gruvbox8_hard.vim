...
if &background == 'dark'
  ...
  hi Normal guifg=#ebdbb2 guibg=#1d2021 guisp=NONE gui=NONE ctermfg=187 ctermbg=234 cterm=NONE term=NONE
  ...
  hi CommandMode guifg=#d3869b guibg=#1d2021 guisp=NONE gui=reverse ctermfg=175 ctermbg=234 cterm=reverse term=reverse
  ...
  hi DiffAdd guifg=#b8bb26 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=142 ctermbg=234 cterm=reverse term=reverse,underline
  hi DiffChange guifg=#8ec07c guibg=#1d2021 guisp=NONE gui=reverse ctermfg=107 ctermbg=234 cterm=reverse term=reverse,underline
  hi DiffDelete guifg=#fb4934 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=203 ctermbg=234 cterm=reverse term=reverse,underline
  hi DiffText guifg=#fabd2f guibg=#1d2021 guisp=NONE gui=reverse ctermfg=214 ctermbg=234 cterm=reverse term=bold,reverse,underline
  hi Directory guifg=#b8bb26 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=NONE
  hi EndOfBuffer guifg=#1d2021 guibg=NONE guisp=NONE gui=NONE ctermfg=234 ctermbg=NONE cterm=NONE term=NONE
  hi Error guifg=#fb4934 guibg=#1d2021 guisp=NONE gui=bold,reverse ctermfg=203 ctermbg=234 cterm=bold,reverse term=reverse
  hi ErrorMsg guifg=#1d2021 guibg=#fb4934 guisp=NONE gui=bold ctermfg=234 ctermbg=203 cterm=bold term=bold,italic,reverse
  ...
  hi IncSearch guifg=#fe8019 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=208 ctermbg=234 cterm=reverse term=bold,italic,reverse
  hi Include guifg=#8ec07c guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE term=NONE
  hi InsertMode guifg=#83a598 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=109 ctermbg=234 cterm=reverse term=reverse
  ...
  hi NormalMode guifg=#a89984 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=137 ctermbg=234 cterm=reverse term=reverse
  ...
  hi ReplaceMode guifg=#8ec07c guibg=#1d2021 guisp=NONE gui=reverse ctermfg=107 ctermbg=234 cterm=reverse term=reverse
  hi Search guifg=#fabd2f guibg=#1d2021 guisp=NONE gui=reverse ctermfg=214 ctermbg=234 cterm=reverse term=italic,underline
  ...
  hi Terminal guifg=#ebdbb2 guibg=#1d2021 guisp=NONE gui=NONE ctermfg=187 ctermbg=234 cterm=NONE term=NONE
  hi Title guifg=#b8bb26 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=bold
  hi Todo guifg=fg guibg=#1d2021 guisp=NONE gui=bold,italic ctermfg=fg ctermbg=234 cterm=bold,italic term=bold,underline
  ...
  hi VertSplit guifg=#665c54 guibg=#1d2021 guisp=NONE gui=NONE ctermfg=59 ctermbg=234 cterm=NONE term=reverse
  hi Visual guifg=NONE guibg=#665c54 guisp=NONE gui=NONE ctermfg=NONE ctermbg=59 cterm=NONE term=reverse
  hi VisualMode guifg=#fe8019 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=208 ctermbg=234 cterm=reverse term=reverse
  hi WarningMsg guifg=#fb4934 guibg=NONE guisp=NONE gui=bold ctermfg=203 ctermbg=NONE cterm=bold term=standout
  hi Warnings guifg=#fe8019 guibg=#1d2021 guisp=NONE gui=reverse ctermfg=208 ctermbg=234 cterm=reverse term=reverse
  ...
  if s:t_Co >= 256
    ...
    if s:ft_bold == 1
      ...
      hi htmlBold ctermfg=fg ctermbg=234 cterm=NONE
      hi htmlBoldItalic ctermfg=fg ctermbg=234 cterm=italic
      hi htmlBoldUnderline ctermfg=fg ctermbg=234 cterm=underline
      hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=234 cterm=italic,underline
    ...
    if s:plugin_bold == 1
      ...
      hi CtrlPMode2 ctermfg=234 ctermbg=109 cterm=NONE
...
if &background == 'light'
  ...
  hi Normal guifg=#3c3836 guibg=#f9f5d7 guisp=NONE gui=NONE ctermfg=237 ctermbg=229 cterm=NONE term=NONE
  ...
  hi CommandMode guifg=#8f3f71 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=126 ctermbg=229 cterm=reverse term=reverse
  hi Comment guifg=#928374 guibg=NONE guisp=NONE gui=italic ctermfg=102 ctermbg=NONE cterm=italic term=italic
  ...
  hi DiffAdd guifg=#79740e guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=100 ctermbg=229 cterm=reverse term=reverse,underline
  hi DiffChange guifg=#427b58 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=29 ctermbg=229 cterm=reverse term=reverse,underline
  hi DiffDelete guifg=#9d0006 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=124 ctermbg=229 cterm=reverse term=reverse,underline
  hi DiffText guifg=#b57614 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=172 ctermbg=229 cterm=reverse term=bold,reverse,underline
  hi Directory guifg=#79740e guibg=NONE guisp=NONE gui=bold ctermfg=100 ctermbg=NONE cterm=bold term=NONE
  hi EndOfBuffer guifg=#f9f5d7 guibg=NONE guisp=NONE gui=NONE ctermfg=229 ctermbg=NONE cterm=NONE term=NONE
  hi Error guifg=#9d0006 guibg=#f9f5d7 guisp=NONE gui=bold,reverse ctermfg=124 ctermbg=229 cterm=bold,reverse term=reverse
  hi ErrorMsg guifg=#f9f5d7 guibg=#9d0006 guisp=NONE gui=bold ctermfg=229 ctermbg=124 cterm=bold term=bold,italic,reverse
  ...
  hi Ignore guifg=fg guibg=NONE guisp=NONE gui=NONE ctermfg=fg ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=#af3a03 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=124 ctermbg=229 cterm=reverse term=bold,italic,reverse
  hi Include guifg=#427b58 guibg=NONE guisp=NONE gui=NONE ctermfg=29 ctermbg=NONE cterm=NONE term=NONE
  hi InsertMode guifg=#076678 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=23 ctermbg=229 cterm=reverse term=reverse
  ...
  hi NormalMode guifg=#7c6f64 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=243 ctermbg=229 cterm=reverse term=reverse
  ...
  hi ReplaceMode guifg=#427b58 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=29 ctermbg=229 cterm=reverse term=reverse
  hi Search guifg=#b57614 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=172 ctermbg=229 cterm=reverse term=italic,underline
  ...
  hi Terminal guifg=#3c3836 guibg=#f9f5d7 guisp=NONE gui=NONE ctermfg=237 ctermbg=229 cterm=NONE term=NONE
  hi Title guifg=#79740e guibg=NONE guisp=NONE gui=bold ctermfg=100 ctermbg=NONE cterm=bold term=bold
  hi Todo guifg=fg guibg=#f9f5d7 guisp=NONE gui=bold,italic ctermfg=fg ctermbg=229 cterm=bold,italic term=bold,underline
  ...
  hi VertSplit guifg=#bdae93 guibg=#f9f5d7 guisp=NONE gui=NONE ctermfg=144 ctermbg=229 cterm=NONE term=reverse
  hi Visual guifg=NONE guibg=#bdae93 guisp=NONE gui=NONE ctermfg=NONE ctermbg=144 cterm=NONE term=reverse
  hi VisualMode guifg=#af3a03 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=124 ctermbg=229 cterm=reverse term=reverse
  hi WarningMsg guifg=#9d0006 guibg=NONE guisp=NONE gui=bold ctermfg=124 ctermbg=NONE cterm=bold term=standout
  hi Warnings guifg=#af3a03 guibg=#f9f5d7 guisp=NONE gui=reverse ctermfg=124 ctermbg=229 cterm=reverse term=reverse
  ...
  if s:t_Co >= 256
    ...
    if s:ft_bold == 1
      ...
      hi htmlBold ctermfg=fg ctermbg=229 cterm=NONE
      hi htmlBoldItalic ctermfg=fg ctermbg=229 cterm=italic
      hi htmlBoldUnderline ctermfg=fg ctermbg=229 cterm=underline
      hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=229 cterm=italic,underline
    ...
    if s:plugin_bold == 1
      ...
      hi CtrlPMode2 ctermfg=229 ctermbg=23 cterm=NONE
