...
" Last Updated: Fri Jun  2 13:06:42 2023
...
if &background == 'dark'
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi Error ctermfg=203 ctermbg=236 cterm=reverse
      hi ErrorMsg ctermfg=236 ctermbg=203 cterm=NONE
      hi Function ctermfg=142 ctermbg=NONE cterm=NONE
      hi MatchParen ctermfg=NONE ctermbg=239 cterm=underline
      hi ModeMsg ctermfg=214 ctermbg=NONE cterm=NONE
      hi MoreMsg ctermfg=214 ctermbg=NONE cterm=NONE
      ...
      hi ToolbarButton ctermfg=230 ctermbg=59 cterm=NONE
      hi WarningMsg ctermfg=203 ctermbg=NONE cterm=NONE
      hi WildMenu ctermfg=109 ctermbg=239 cterm=NONE
    endif
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=236 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=236 cterm=italic
    elseif s:bold_italic == 2
      hi Todo ctermfg=fg ctermbg=236 cterm=bold
    endif
    if s:ft == 1
  ...
  if str2nr(&t_Co) >= 16
    ...
    if s:bold == 0
      ...
      hi MatchParen ctermfg=NONE ctermbg=Black cterm=underline
    ...
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=Black cterm=italic
    elseif s:bold_italic == 2
  ...
  if str2nr(&t_Co) >= 8
    ...
    if s:bold == 0
      ...
      hi ErrorMsg ctermfg=Black ctermbg=Red cterm=NONE
      hi Function ctermfg=Green ctermbg=NONE cterm=NONE
      hi MatchParen ctermfg=Gray ctermbg=NONE cterm=underline
      hi ModeMsg ctermfg=Yellow ctermbg=NONE cterm=NONE
      hi MoreMsg ctermfg=Yellow ctermbg=NONE cterm=NONE
      hi Question ctermfg=Magenta ctermbg=NONE cterm=NONE
      hi Title ctermfg=Green ctermbg=NONE cterm=NONE
      hi ToolbarButton ctermfg=Black ctermbg=Gray cterm=NONE
      hi WarningMsg ctermfg=Red ctermbg=NONE cterm=NONE
      hi WildMenu ctermfg=Blue ctermbg=DarkGray cterm=NONE
    endif
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=Black cterm=NONE
    elseif s:bold_italic == 1
...
if &background == 'light'
  ...
  hi Terminal guifg=#f2e5bc guibg=#3c3836 guisp=NONE gui=NONE
  ...
  if str2nr(&t_Co) >= 256
    ...
    if s:bold == 0
      ...
      hi Error ctermfg=124 ctermbg=187 cterm=reverse
      hi ErrorMsg ctermfg=187 ctermbg=124 cterm=NONE
      hi Function ctermfg=100 ctermbg=NONE cterm=NONE
      hi MatchParen ctermfg=NONE ctermbg=180 cterm=underline
      hi ModeMsg ctermfg=172 ctermbg=NONE cterm=NONE
      hi MoreMsg ctermfg=172 ctermbg=NONE cterm=NONE
      hi PmenuSel ctermfg=180 ctermbg=23 cterm=NONE
      hi Question ctermfg=124 ctermbg=NONE cterm=NONE
      hi Title ctermfg=100 ctermbg=NONE cterm=NONE
      hi ToolbarButton ctermfg=235 ctermbg=144 cterm=NONE
      hi WarningMsg ctermfg=124 ctermbg=NONE cterm=NONE
      hi WildMenu ctermfg=23 ctermbg=180 cterm=NONE
    endif
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=187 cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=187 cterm=italic
    elseif s:bold_italic == 2
      hi Todo ctermfg=fg ctermbg=187 cterm=bold
    endif
    if s:ft == 1
  ...
  if str2nr(&t_Co) >= 16
    ...
    if s:bold == 0
      ...
      hi Function ctermfg=Green ctermbg=NONE cterm=NONE
      hi MatchParen ctermfg=NONE ctermbg=White cterm=underline
      hi ModeMsg ctermfg=Yellow ctermbg=NONE cterm=NONE
      hi MoreMsg ctermfg=Yellow ctermbg=NONE cterm=NONE
      hi Question ctermfg=Magenta ctermbg=NONE cterm=NONE
      hi Title ctermfg=Green ctermbg=NONE cterm=NONE
    ...
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=White cterm=NONE
    elseif s:bold_italic == 1
      hi Todo ctermfg=fg ctermbg=White cterm=italic
    elseif s:bold_italic == 2
  ...
  if str2nr(&t_Co) >= 8
    ...
    if s:bold == 0
      ...
      hi WarningMsg ctermfg=Red ctermbg=NONE cterm=NONE
      hi WildMenu ctermfg=Blue ctermbg=Grey cterm=NONE
    endif
    if s:bold_italic == 0
      hi Todo ctermfg=fg ctermbg=White cterm=NONE
    elseif s:bold_italic == 1
