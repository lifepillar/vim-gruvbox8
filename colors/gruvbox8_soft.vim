...
" Last Updated: Sat Jun  5 17:01:51 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocErrorSign guifg=#fb4934 guibg=NONE gui=NONE cterm=NONE
      hi CocWarningSign guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi CocInfoSign guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
      hi CocHintSign guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
      hi CocUnderline guifg=NONE guibg=NONE
      hi CocErrorFloat guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
      hi CocWarningFloat guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
      hi CocInfoFloat guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
      hi CocHintFloat guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
      hi CocErrorVirtualText guifg=#fb4934 guibg=#32302f gui=NONE cterm=NONE
      hi CocWarningVirtualText guifg=#fe8019 guibg=#32302f gui=NONE cterm=NONE
      hi CocInfoVirtualText guifg=#fabd2f guibg=#32302f gui=NONE cterm=NONE
      hi CocHintVirtualText guifg=#83a598 guibg=#32302f gui=NONE cterm=NONE
      hi CocErrorHighlight guifg=NONE guibg=NONE
      hi CocWarningHighlight guifg=NONE guibg=NONE
      hi CocInfoHighlight guifg=NONE guibg=NONE
      hi CocHintHighlight guifg=NONE guibg=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign guifg=#9d0006 guibg=NONE gui=NONE cterm=NONE
    hi CocWarningSign guifg=#af3a03 guibg=NONE gui=NONE cterm=NONE
    hi CocInfoSign guifg=#b57614 guibg=NONE gui=NONE cterm=NONE
    hi CocHintSign guifg=#076678 guibg=NONE gui=NONE cterm=NONE
    hi CocUnderline guifg=NONE guibg=NONE
    hi CocErrorFloat guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CocWarningFloat guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CocInfoFloat guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CocHintFloat guifg=#3c3836 guibg=NONE gui=NONE cterm=NONE
    hi CocErrorVirtualText guifg=#9d0006 guibg=#f2e5bc gui=NONE cterm=NONE
    hi CocWarningVirtualText guifg=#af3a03 guibg=#f2e5bc gui=NONE cterm=NONE
    hi CocInfoVirtualText guifg=#b57614 guibg=#f2e5bc gui=NONE cterm=NONE
    hi CocHintVirtualText guifg=#076678 guibg=#f2e5bc gui=NONE cterm=NONE
    hi CocErrorHighlight guifg=NONE guibg=NONE
    hi CocWarningHighlight guifg=NONE guibg=NONE
    hi CocInfoHighlight guifg=NONE guibg=NONE
    hi CocHintHighlight guifg=NONE guibg=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocErrorSign ctermfg=203 ctermbg=NONE cterm=NONE
      hi CocWarningSign ctermfg=208 ctermbg=NONE cterm=NONE
      hi CocInfoSign ctermfg=214 ctermbg=NONE cterm=NONE
      hi CocHintSign ctermfg=109 ctermbg=NONE cterm=NONE
      hi CocUnderline ctermfg=NONE ctermbg=NONE
      hi CocErrorFloat ctermfg=187 ctermbg=NONE cterm=NONE
      hi CocWarningFloat ctermfg=187 ctermbg=NONE cterm=NONE
      hi CocInfoFloat ctermfg=187 ctermbg=NONE cterm=NONE
      hi CocHintFloat ctermfg=187 ctermbg=NONE cterm=NONE
      hi CocErrorVirtualText ctermfg=203 ctermbg=236 cterm=NONE
      hi CocWarningVirtualText ctermfg=208 ctermbg=236 cterm=NONE
      hi CocInfoVirtualText ctermfg=214 ctermbg=236 cterm=NONE
      hi CocHintVirtualText ctermfg=109 ctermbg=236 cterm=NONE
      hi CocErrorHighlight ctermfg=NONE ctermbg=NONE
      hi CocWarningHighlight ctermfg=NONE ctermbg=NONE
      hi CocInfoHighlight ctermfg=NONE ctermbg=NONE
      hi CocHintHighlight ctermfg=NONE ctermbg=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign ctermfg=124 ctermbg=NONE cterm=NONE
    hi CocWarningSign ctermfg=124 ctermbg=NONE cterm=NONE
    hi CocInfoSign ctermfg=172 ctermbg=NONE cterm=NONE
    hi CocHintSign ctermfg=23 ctermbg=NONE cterm=NONE
    hi CocUnderline ctermfg=NONE ctermbg=NONE
    hi CocErrorFloat ctermfg=237 ctermbg=NONE cterm=NONE
    hi CocWarningFloat ctermfg=237 ctermbg=NONE cterm=NONE
    hi CocInfoFloat ctermfg=237 ctermbg=NONE cterm=NONE
    hi CocHintFloat ctermfg=237 ctermbg=NONE cterm=NONE
    hi CocErrorVirtualText ctermfg=124 ctermbg=187 cterm=NONE
    hi CocWarningVirtualText ctermfg=124 ctermbg=187 cterm=NONE
    hi CocInfoVirtualText ctermfg=172 ctermbg=187 cterm=NONE
    hi CocHintVirtualText ctermfg=23 ctermbg=187 cterm=NONE
    hi CocErrorHighlight ctermfg=NONE ctermbg=NONE
    hi CocWarningHighlight ctermfg=NONE ctermbg=NONE
    hi CocInfoHighlight ctermfg=NONE ctermbg=NONE
    hi CocHintHighlight ctermfg=NONE ctermbg=NONE
