...
if &background == 'dark'
  ...
  hi Normal guifg=#ebdbb2 guibg=#32302f guisp=NONE gui=NONE ctermfg=187 ctermbg=236 cterm=NONE term=NONE
  ...
  hi CommandMode guifg=#d3869b guibg=#32302f guisp=NONE gui=reverse ctermfg=175 ctermbg=236 cterm=reverse term=reverse
  ...
  hi DiffAdd guifg=#b8bb26 guibg=#32302f guisp=NONE gui=reverse ctermfg=142 ctermbg=236 cterm=reverse term=reverse,underline
  hi DiffChange guifg=#8ec07c guibg=#32302f guisp=NONE gui=reverse ctermfg=107 ctermbg=236 cterm=reverse term=reverse,underline
  hi DiffDelete guifg=#fb4934 guibg=#32302f guisp=NONE gui=reverse ctermfg=203 ctermbg=236 cterm=reverse term=reverse,underline
  hi DiffText guifg=#fabd2f guibg=#32302f guisp=NONE gui=reverse ctermfg=214 ctermbg=236 cterm=reverse term=bold,reverse,underline
  hi Directory guifg=#b8bb26 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=NONE
  hi EndOfBuffer guifg=#32302f guibg=NONE guisp=NONE gui=NONE ctermfg=236 ctermbg=NONE cterm=NONE term=NONE
  hi Error guifg=#fb4934 guibg=#32302f guisp=NONE gui=bold,reverse ctermfg=203 ctermbg=236 cterm=bold,reverse term=reverse
  hi ErrorMsg guifg=#32302f guibg=#fb4934 guisp=NONE gui=bold ctermfg=236 ctermbg=203 cterm=bold term=bold,italic,reverse
  ...
  hi IncSearch guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse ctermfg=208 ctermbg=236 cterm=reverse term=bold,italic,reverse
  hi Include guifg=#8ec07c guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE term=NONE
  hi InsertMode guifg=#83a598 guibg=#32302f guisp=NONE gui=reverse ctermfg=109 ctermbg=236 cterm=reverse term=reverse
  ...
  hi NormalMode guifg=#a89984 guibg=#32302f guisp=NONE gui=reverse ctermfg=137 ctermbg=236 cterm=reverse term=reverse
  ...
  hi ReplaceMode guifg=#8ec07c guibg=#32302f guisp=NONE gui=reverse ctermfg=107 ctermbg=236 cterm=reverse term=reverse
  hi Search guifg=#fabd2f guibg=#32302f guisp=NONE gui=reverse ctermfg=214 ctermbg=236 cterm=reverse term=italic,underline
  ...
  hi Terminal guifg=#ebdbb2 guibg=#32302f guisp=NONE gui=NONE ctermfg=187 ctermbg=236 cterm=NONE term=NONE
  hi Title guifg=#b8bb26 guibg=NONE guisp=NONE gui=bold ctermfg=142 ctermbg=NONE cterm=bold term=bold
  hi Todo guifg=fg guibg=#32302f guisp=NONE gui=bold,italic ctermfg=fg ctermbg=236 cterm=bold,italic term=bold,underline
  ...
  hi VertSplit guifg=#665c54 guibg=#32302f guisp=NONE gui=NONE ctermfg=59 ctermbg=236 cterm=NONE term=reverse
  hi Visual guifg=NONE guibg=#665c54 guisp=NONE gui=NONE ctermfg=NONE ctermbg=59 cterm=NONE term=reverse
  hi VisualMode guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse ctermfg=208 ctermbg=236 cterm=reverse term=reverse
  hi WarningMsg guifg=#fb4934 guibg=NONE guisp=NONE gui=bold ctermfg=203 ctermbg=NONE cterm=bold term=standout
  hi Warnings guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse ctermfg=208 ctermbg=236 cterm=reverse term=reverse
  ...
  if s:t_Co >= 256
    ...
    if s:ft_bold == 1
      ...
      hi htmlBold ctermfg=fg ctermbg=236 cterm=NONE
      hi htmlBoldItalic ctermfg=fg ctermbg=236 cterm=italic
      hi htmlBoldUnderline ctermfg=fg ctermbg=236 cterm=underline
      hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=236 cterm=italic,underline
    ...
    if s:plugin_bold == 1
      ...
      hi CtrlPMode2 ctermfg=236 ctermbg=109 cterm=NONE
...
if &background == 'light'
  ...
  hi Normal guifg=#3c3836 guibg=#f2e5bc guisp=NONE gui=NONE ctermfg=237 ctermbg=187 cterm=NONE term=NONE
  ...
  hi ColorColumn guifg=NONE guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=NONE ctermbg=251 cterm=NONE term=reverse
  hi CommandMode guifg=#8f3f71 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=126 ctermbg=187 cterm=reverse term=reverse
  hi Comment guifg=#928374 guibg=NONE guisp=NONE gui=italic ctermfg=102 ctermbg=NONE cterm=italic term=italic
  ...
  hi Cursor guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse term=NONE
  hi CursorIM guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse term=NONE
  hi CursorLine guifg=NONE guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=NONE ctermbg=251 cterm=NONE term=underline
  hi CursorLineNr guifg=#b57614 guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=172 ctermbg=251 cterm=NONE term=bold,italic,reverse,underline
  ...
  hi DiffAdd guifg=#79740e guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=100 ctermbg=187 cterm=reverse term=reverse,underline
  hi DiffChange guifg=#427b58 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=29 ctermbg=187 cterm=reverse term=reverse,underline
  hi DiffDelete guifg=#9d0006 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=124 ctermbg=187 cterm=reverse term=reverse,underline
  hi DiffText guifg=#b57614 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=172 ctermbg=187 cterm=reverse term=bold,reverse,underline
  hi Directory guifg=#79740e guibg=NONE guisp=NONE gui=bold ctermfg=100 ctermbg=NONE cterm=bold term=NONE
  hi EndOfBuffer guifg=#f2e5bc guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE term=NONE
  hi Error guifg=#9d0006 guibg=#f2e5bc guisp=NONE gui=bold,reverse ctermfg=124 ctermbg=187 cterm=bold,reverse term=reverse
  hi ErrorMsg guifg=#f2e5bc guibg=#9d0006 guisp=NONE gui=bold ctermfg=187 ctermbg=124 cterm=bold term=bold,italic,reverse
  ...
  hi FoldColumn guifg=#928374 guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=102 ctermbg=251 cterm=NONE term=reverse
  hi Folded guifg=#928374 guibg=#ebdbb2 guisp=NONE gui=italic ctermfg=102 ctermbg=251 cterm=italic term=italic,reverse,underline
  ...
  hi Ignore guifg=fg guibg=NONE guisp=NONE gui=NONE ctermfg=fg ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=124 ctermbg=187 cterm=reverse term=bold,italic,reverse
  hi Include guifg=#427b58 guibg=NONE guisp=NONE gui=NONE ctermfg=29 ctermbg=NONE cterm=NONE term=NONE
  hi InsertMode guifg=#076678 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=23 ctermbg=187 cterm=reverse term=reverse
  ...
  hi MatchParen guifg=NONE guibg=#d5c4a1 guisp=NONE gui=bold,underline ctermfg=NONE ctermbg=180 cterm=bold,underline term=bold,underline
  ...
  hi NonText guifg=#d5c4a1 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE term=NONE
  hi NormalMode guifg=#7c6f64 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=243 ctermbg=187 cterm=reverse term=reverse
  ...
  hi Pmenu guifg=#3c3836 guibg=#d5c4a1 guisp=NONE gui=NONE ctermfg=237 ctermbg=180 cterm=NONE term=reverse
  hi PmenuSbar guifg=NONE guibg=#d5c4a1 guisp=NONE gui=NONE ctermfg=NONE ctermbg=180 cterm=NONE term=NONE
  hi PmenuSel guifg=#d5c4a1 guibg=#076678 guisp=NONE gui=bold ctermfg=180 ctermbg=23 cterm=bold term=NONE
  ...
  hi ReplaceMode guifg=#427b58 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=29 ctermbg=187 cterm=reverse term=reverse
  hi Search guifg=#b57614 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=172 ctermbg=187 cterm=reverse term=italic,underline
  hi SignColumn guifg=#3c3836 guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=237 ctermbg=251 cterm=NONE term=reverse
  ...
  hi StatusLine guifg=#d5c4a1 guibg=#3c3836 guisp=NONE gui=reverse ctermfg=180 ctermbg=237 cterm=reverse term=bold,reverse
  hi StatusLineNC guifg=#ebdbb2 guibg=#7c6f64 guisp=NONE gui=reverse ctermfg=251 ctermbg=243 cterm=reverse term=reverse
  ...
  hi TabLine guifg=#a89984 guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=137 ctermbg=251 cterm=NONE term=italic,reverse,underline
  hi TabLineFill guifg=#a89984 guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=137 ctermbg=251 cterm=NONE term=reverse,underline
  hi TabLineSel guifg=#79740e guibg=#ebdbb2 guisp=NONE gui=NONE ctermfg=100 ctermbg=251 cterm=NONE term=bold
  hi TermCursorNC guifg=#ebdbb2 guibg=#3c3836 guisp=NONE gui=NONE ctermfg=251 ctermbg=237 cterm=NONE term=NONE
  hi Terminal guifg=#3c3836 guibg=#f2e5bc guisp=NONE gui=NONE ctermfg=237 ctermbg=187 cterm=NONE term=NONE
  hi Title guifg=#79740e guibg=NONE guisp=NONE gui=bold ctermfg=100 ctermbg=NONE cterm=bold term=bold
  hi Todo guifg=fg guibg=#f2e5bc guisp=NONE gui=bold,italic ctermfg=fg ctermbg=187 cterm=bold,italic term=bold,underline
  ...
  hi VertSplit guifg=#bdae93 guibg=#f2e5bc guisp=NONE gui=NONE ctermfg=144 ctermbg=187 cterm=NONE term=reverse
  hi Visual guifg=NONE guibg=#bdae93 guisp=NONE gui=NONE ctermfg=NONE ctermbg=144 cterm=NONE term=reverse
  hi VisualMode guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=124 ctermbg=187 cterm=reverse term=reverse
  hi WarningMsg guifg=#9d0006 guibg=NONE guisp=NONE gui=bold ctermfg=124 ctermbg=NONE cterm=bold term=standout
  hi Warnings guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse ctermfg=124 ctermbg=187 cterm=reverse term=reverse
  hi WildMenu guifg=#076678 guibg=#d5c4a1 guisp=NONE gui=bold ctermfg=23 ctermbg=180 cterm=bold term=bold
  ...
  if s:t_Co >= 256
    ...
    if s:ft_bold == 1
      ...
      hi htmlBold ctermfg=fg ctermbg=187 cterm=NONE
      hi htmlBoldItalic ctermfg=fg ctermbg=187 cterm=italic
      hi htmlBoldUnderline ctermfg=fg ctermbg=187 cterm=underline
      hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=187 cterm=italic,underline
    ...
    if s:plugin_bold == 1
      hi CtrlPMode1 ctermfg=23 ctermbg=180 cterm=NONE
      hi CtrlPMode2 ctermfg=187 ctermbg=23 cterm=NONE
      hi CtrlPStats ctermfg=243 ctermbg=180 cterm=NONE
    elseif s:plugin_bold == 3
