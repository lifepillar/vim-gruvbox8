...
" Last Updated: Sat Jun  5 16:29:03 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocInfoSign guifg=#8ec07c guibg=#3c3836 gui=NONE cterm=NONE
      hi CocHintSign guifg=#8ec07c guibg=#3c3836 gui=NONE cterm=NONE
      hi CocErrorFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocWarningFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocInfoFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocHintFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi CocHintVirtualText guifg=#8ec07c guibg=NONE gui=NONE cterm=NONE
      hi CocErrorHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocWarningHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocInfoHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocHintHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi LspDiagnosticsUnderlineError guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi LspDiagnosticsUnderlineWarning guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi LspDiagnosticsUnderlineInformation guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi LspDiagnosticsUnderlineHint guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocInfoSign guifg=#427b58 guibg=#ebdbb2 gui=NONE cterm=NONE
    hi CocHintSign guifg=#427b58 guibg=#ebdbb2 gui=NONE cterm=NONE
    hi CocErrorFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocWarningFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocInfoFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocHintFloat guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    ...
    hi CocHintVirtualText guifg=#427b58 guibg=NONE gui=NONE cterm=NONE
    hi CocErrorHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocWarningHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocInfoHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocHintHighlight guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocInfoSign ctermfg=107 ctermbg=237 cterm=NONE
      hi CocHintSign ctermfg=107 ctermbg=237 cterm=NONE
      hi CocErrorFloat ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocWarningFloat ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocInfoFloat ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocHintFloat ctermfg=NONE ctermbg=NONE cterm=NONE
      ...
      hi CocHintVirtualText ctermfg=107 ctermbg=NONE cterm=NONE
      hi CocErrorHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocWarningHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocInfoHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
      hi CocHintHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocInfoSign ctermfg=29 ctermbg=251 cterm=NONE
    hi CocHintSign ctermfg=29 ctermbg=251 cterm=NONE
    hi CocErrorFloat ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocWarningFloat ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocInfoFloat ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocHintFloat ctermfg=NONE ctermbg=NONE cterm=NONE
    ...
    hi CocHintVirtualText ctermfg=29 ctermbg=NONE cterm=NONE
    hi CocErrorHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocWarningHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocInfoHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
    hi CocHintHighlight ctermfg=NONE ctermbg=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignHint ctermfg=29 ctermbg=251 cterm=NONE
    hi LspDiagnosticsUnderlineHint ctermfg=NONE ctermbg=NONE cterm=NONE
