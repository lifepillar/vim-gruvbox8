...
" Last Updated: Fri May 28 23:34:31 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi LspDiagnosticsSignError guifg=#fb4934 guibg=#32302f gui=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi LspDiagnosticsSignError guifg=#9d0006 guibg=#f2e5bc gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi LspDiagnosticsSignError ctermfg=203 ctermbg=236 cterm=NONE
