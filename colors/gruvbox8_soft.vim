...
" Last Updated: Sat Jun  5 16:46:56 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocErrorSign guifg=#fb4934 guibg=#3c3836 gui=reverse cterm=reverse
      hi CocWarningSign guifg=#fe8019 guibg=#3c3836 gui=reverse cterm=reverse
      hi CocInfoSign guifg=#fabd2f guibg=#3c3836 gui=reverse cterm=reverse
      hi CocHintSign guifg=#83a598 guibg=#3c3836 gui=reverse cterm=reverse
      ...
      hi CocErrorVirtualText guifg=#fb4934 guibg=NONE gui=NONE cterm=NONE
      hi CocWarningVirtualText guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi CocInfoVirtualText guifg=#fabd2f guibg=NONE gui=NONE cterm=NONE
      hi CocHintVirtualText guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign guifg=#9d0006 guibg=#ebdbb2 gui=reverse cterm=reverse
    hi CocWarningSign guifg=#af3a03 guibg=#ebdbb2 gui=reverse cterm=reverse
    hi CocInfoSign guifg=#b57614 guibg=#ebdbb2 gui=reverse cterm=reverse
    hi CocHintSign guifg=#076678 guibg=#ebdbb2 gui=reverse cterm=reverse
    ...
    hi CocErrorVirtualText guifg=#9d0006 guibg=NONE gui=NONE cterm=NONE
    hi CocWarningVirtualText guifg=#af3a03 guibg=NONE gui=NONE cterm=NONE
    hi CocInfoVirtualText guifg=#b57614 guibg=NONE gui=NONE cterm=NONE
    hi CocHintVirtualText guifg=#076678 guibg=NONE gui=NONE cterm=NONE
    hi CocErrorHighlight guifg=NONE guibg=NONE
    hi CocWarningHighlight guifg=NONE guibg=NONE
    hi CocInfoHighlight guifg=NONE guibg=NONE
    hi CocHintHighlight guifg=NONE guibg=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CocErrorSign ctermfg=203 ctermbg=237 cterm=reverse
      hi CocWarningSign ctermfg=208 ctermbg=237 cterm=reverse
      hi CocInfoSign ctermfg=214 ctermbg=237 cterm=reverse
      hi CocHintSign ctermfg=109 ctermbg=237 cterm=reverse
      ...
      hi CocErrorVirtualText ctermfg=203 ctermbg=NONE cterm=NONE
      hi CocWarningVirtualText ctermfg=208 ctermbg=NONE cterm=NONE
      hi CocInfoVirtualText ctermfg=214 ctermbg=NONE cterm=NONE
      hi CocHintVirtualText ctermfg=109 ctermbg=NONE cterm=NONE
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi CocErrorSign ctermfg=124 ctermbg=251 cterm=reverse
    hi CocWarningSign ctermfg=124 ctermbg=251 cterm=reverse
    hi CocInfoSign ctermfg=172 ctermbg=251 cterm=reverse
    hi CocHintSign ctermfg=23 ctermbg=251 cterm=reverse
    ...
    hi CocErrorVirtualText ctermfg=124 ctermbg=NONE cterm=NONE
    hi CocWarningVirtualText ctermfg=124 ctermbg=NONE cterm=NONE
    hi CocInfoVirtualText ctermfg=172 ctermbg=NONE cterm=NONE
    hi CocHintVirtualText ctermfg=23 ctermbg=NONE cterm=NONE
    hi CocErrorHighlight ctermfg=NONE ctermbg=NONE
    hi CocWarningHighlight ctermfg=NONE ctermbg=NONE
    hi CocInfoHighlight ctermfg=NONE ctermbg=NONE
    hi CocHintHighlight ctermfg=NONE ctermbg=NONE
